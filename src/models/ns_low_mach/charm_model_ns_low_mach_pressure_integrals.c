 ...
 * Surface integrals
 */
static void _charm_model_ns_low_mach_pressure_integrals_surface_int_iter_bnd (p4est_iter_face_info_t * info, void *user_data) {
    int i, ibf, igp;
...
static void _charm_model_ns_low_mach_pressure_integrals_surface_int_iter_inner (p4est_iter_face_info_t * info, void *user_data)
{
...
static void _charm_model_ns_low_mach_pressure_integrals_surface_int_iter_fn (p4est_iter_face_info_t * info, void *user_data)
{
    sc_array_t         *sides = &(info->sides);

    if (sides->elem_count != 2) {
        _charm_model_ns_low_mach_pressure_integrals_surface_int_iter_bnd(info, user_data);
    }
    else {
        _charm_model_ns_low_mach_pressure_integrals_surface_int_iter_inner(info, user_data);
    }
...
void charm_model_ns_low_mach_pressure_integrals(p4est_t * p4est, p4est_ghost_t * ghost, charm_data_t * ghost_data)
{
    p4est_iterate (p4est,
                   ghost,
                   (void *) ghost_data,
                   _charm_model_ns_low_mach_pressure_integrals_volume_int_iter_fn,
                   _charm_model_ns_low_mach_pressure_integrals_surface_int_iter_fn,
                   NULL, NULL);
