...
static void charm_model_ns_jfnk_geom_calc_face_iter_fn (p4est_iter_face_info_t * info, void *user_data)
{
...
static void charm_model_ns_jfnk_geom_calc_quad_iter_fn(p4est_iter_volume_info_t * info, void *user_data)
{
    sc_array_t         *fc = user_data;
...
void charm_model_ns_jfnk_geom_calc(p4est_t *p4est)
{
    ...
    if (ctx->model.ns_jfnk.turb.model_type == TURB_MODEL_UNKNOWN) return;
    ...
    p4est_iterate (p4est,
                   ...
                   (void *) fc,
                   NULL,
                   charm_model_ns_jfnk_geom_calc_face_iter_fn,
                   NULL, NULL);
    p4est_iterate (p4est,
                   NULL,
                   (void *) fc,
                   charm_model_ns_jfnk_geom_calc_quad_iter_fn,
                   NULL, NULL, NULL);
    sc_array_destroy(fc);
}