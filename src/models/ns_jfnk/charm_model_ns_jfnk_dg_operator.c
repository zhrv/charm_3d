...
static inline void _charm_model_ns_jfnk_dg_operator_stash_push_quad_iter_fn(p4est_iter_volume_info_t *info, void *user_data)
{
...
{
    p4est_iterate(p4est, NULL, NULL, _charm_model_ns_jfnk_dg_operator_stash_push_quad_iter_fn, NULL, NULL, NULL);
}




static inline void _charm_model_ns_jfnk_dg_operator_stash_pop_quad_iter_fn(p4est_iter_volume_info_t *info, void *user_data)
{
    charm_data_t       *data = charm_get_quad_data(info->quad);
    charm_ctx_t        *ctx = (charm_ctx_t*)info->p4est->user_pointer;
    charm_size_t              c_count = ctx->comp->elem_count;
...
static void _charm_model_ns_jfnk_dg_operator_zero_quad_iter_fn (p4est_iter_volume_info_t * info, void *user_data)
{
    charm_data_t       *data = charm_get_quad_data(info->quad);
    charm_ctx_t        *ctx = (charm_ctx_t*)info->p4est->user_pointer;
    charm_size_t              c_count = ctx->comp->elem_count;
...
static void _charm_model_ns_jfnk_dg_operator_update_quad_iter_fn (p4est_iter_volume_info_t * info, void *user_data)
{
    charm_data_t       *data = charm_get_quad_data(info->quad);
    charm_ctx_t        *ctx = (charm_ctx_t*)info->p4est->user_pointer;
    charm_size_t              c_count = ctx->comp->elem_count;
...
void charm_model_ns_jfnk_dg_operator(p4est_t * p4est, p4est_ghost_t * ghost, charm_data_t * ghost_data) 
{
    ...
    p4est_iterate (p4est, NULL, NULL,               
            _charm_model_ns_jfnk_dg_operator_zero_quad_iter_fn,         
            NULL, NULL, NULL);                                      
    ...
    p4est_iterate (p4est, NULL, (void *) &(ctx->tmp.ns_jfnk.dt),                        
            _charm_model_ns_jfnk_dg_operator_update_quad_iter_fn,       
            NULL, NULL, NULL);                                      
    p4est_ghost_exchange_data (p4est, ghost, ghost_data);           
