...
set(CHARM_VERSION 0.0.0)
find_program(GIT_VERSION_GEN NAMES git-version-gen
             PATHS ${CMAKE_CURRENT_SOURCE_DIR}/cmake NO_DEFAULT_PATH)
if(GIT_VERSION_GEN)
...
if(_err EQUAL 0)
  if(git_version MATCHES
                 "^(0|[1-9][0-9]*)[.](0|[1-9][0-9]*)[.](0|[1-9][0-9]*)[-]([a-z0-1]*).*")
    set(PROJECT_MAJOR "${CMAKE_MATCH_1}")
    set(PROJECT_MINOR "${CMAKE_MATCH_2}")
    set(PROJECT_PATCH "${CMAKE_MATCH_3}")
    set(CHARM_VERSION ${PROJECT_MAJOR}.${PROJECT_MINOR}.${PROJECT_PATCH}-${CMAKE_MATCH_4})
